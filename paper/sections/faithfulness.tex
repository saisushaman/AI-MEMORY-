...
extracted from. In a $400$-fact sample, only $1$ was judged unsupported
($0.2\%$; the lone case invented a future plan not stated in the dialogue). The
extractor over-\emph{produces} facts (it inflates the store
