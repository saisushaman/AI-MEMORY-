...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{figures/fig_redundancy.png}
\caption{Semantic near-duplicate rate (\mdr) of the deployed \texttt{qwen3:8b}
store vs.\ threshold $\tau$. Lexical matching (dotted) is blind to the
redundancy embeddings expose; a similarity gate leaves a band just below its
threshold.}
