...
largely faithful ($1/400$, $0.2\%$, sampled facts unsupported), unlike open-ended
generation. These findings are robust: the deduplication result holds under a
second judge and a second answerer model, and the temporal-reasoning floor
replicates on a second dataset (LongMemEval). Our contribution is not a new
method---the space is
