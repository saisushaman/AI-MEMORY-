...
agree on $85.2\%$ of $3{,}834$ items (Cohen's $\kappa = 0.60$, moderate);
\texttt{llama3.2} is stricter (positive rate $0.18$ vs.\ $0.30$). Crucially, the
...
fixed as \texttt{qwen3:8b}), on $n{=}200$ questions per policy at
$k\in\{8,12\}$. The ordering again replicates: naive-dedup is dominated
($0.155$ at both budgets vs.\ full $0.300$/$0.315$) and query-aware $\approx$
full ($0.275$/$0.315$, equal at $k{=}12$). Finding (i) survives a change of the
